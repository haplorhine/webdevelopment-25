    ...
    <div class="hero-content flex-col lg:flex-row-reverse gap-12 w-full">
      ...
      <div class="card bg-base-100 w-full max-w-md shadow-2xl">
        ...
        <form class="card-body space-y-4" @submit.prevent="handleSubmit">
          ...
          <!-- SALUTATION OTHER TEXT FIELD (only when "other" is selected) -->
          ...
          <!-- SUBMIT BUTTON (styled like navbar links) -->
          <div class="card-actions justify-end mt-2">
            <!--
              btn-ghost     → similar style to navbar Home/About/Register
              normal-case   → keep text case like regular words
              rounded-full  → pill shape
              px-6          → nice horizontal padding
            -->
            <button
              type="submit"
              class="btn btn-ghost normal-case rounded-full px-6"
            >
              Register
            </button>
          </div>
